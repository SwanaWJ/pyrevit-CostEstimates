...
CATEGORY_DESCRIPTIONS = {
    ...
    "Roofs": "Corrugated roofing sheets laid on steel purlins with treated timber trusses."
}
    ...
    for category_name, bic in CATEGORY_MAP.items():
        ...
        for el in elements:
            try:
                ...
                # --- Apply your preferred unit logic ---
        ...
        if grouped:
            ...
            writer.writerow(["", "Subtotal", "", "", "", round(subtotal, 2)])
